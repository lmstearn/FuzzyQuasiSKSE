...
template<typename t_key, typename t_data> t_data * IRangeMap<t_key, t_data>::Add(t_key start, t_key length)
{
	t_data	* result = NULL;
	Entry	* entry = NULL;
...
template<typename t_key, typename t_data> t_data * IRangeMap<t_key, t_data>::Lookup(t_key addr, t_key * base, t_key * length)
{
	t_data	* result = NULL;
...
template <typename t_key, typename t_data> bool	IRangeMap<t_key, t_data>::Erase(t_key addr, t_key * base, t_key * length)
{
	bool result = false;
...
t_key IRangeMap<t_key, t_data>::GetDataRangeLength(t_data * data)
{
...
template<typename t_key, typename t_data>
typename IRangeMap<t_key,t_data>::Iterator IRangeMap<t_key, t_data>::LookupIter(t_key addr)
{
...
template<typename t_key, typename t_data>
typename IRangeMap<t_key,t_data>::Iterator IRangeMap<t_key, t_data>::Begin(void)
{
	return m_entries.begin();
}

template<typename t_key, typename t_data>
typename IRangeMap<t_key,t_data>::Iterator IRangeMap<t_key, t_data>::End(void)
{
